...
OnTimer120000:
	stopnpctimer;
	mobevent "2009rwc_03",50,50,"Punto de Captura",1288,2,1,0,1,100000,0,0,1,0,0,0,0,0,"PVPEvent::OnControl";
...
OnControl:
	if( pvpeventcheck() )
	{
		...
		mobevent "2009rwc_03",0,0,"Explosivo",1142,1,20,0,0,200000,0,0,1,0,0,0,0,0;
...
OnInit:
	// Mobs ID's y Arrays
	setarray .Reality$[0],"Einbech","Plasma","Ice","Ayothaya","Louyang","Umbala","Nilfheim";
