...
-	script	Chronos Girl	-1,{
	...
	switch( select("^0000FFSuministros de Viajes^000000","^FF0000Restauración Total^000000 (" + @Cost + " zeny)","^2E8B57Guardar / Save^000000","^FFA500Teleport^000000 (" + @Cost + " zeny)","^FFA500Warp Portal^000000 (2.500 zeny)","Arriendo","^808080Reset de Skills^000000","^808080Reset de Stats^000000","^2F4F4FReset Total^000000","^556B2FReset Homunculus^000000","^0000FFSkills Platinum^000000","^FFA500Profesiones^000000") )
	{
		...
		case 3: // Save
			mes "[^FFA500Chronos Girl^000000]";
			mes "Deseas guardar en esta ubicación?";
			next;
			if( select("Sí, guardar aquí mi respawn:No gracias") == 2 )
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "No te realizé ningun cambio.";
				close;
			}
		...
		case 5: // Warp Portal
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "El costo por la operación es de " + @Cost + " zeny";
			...
			{ // Warp Portal Range
				...
				{
					mes "[^FFA500Chronos Girl^000000]";
					mes "Para abrir un Warp Portal debes estar más cerca de mi.";
					mes "Máximo de 2 celdas de distancia.";
					close;
				}
			}
			
			set .@pmenu, @menu; // Previous Menu option
			set .@Zone, select("^FFA500Ultimo Warp^000000","Ciudades Midgard","Ciudades Schwarzwald","Ciudades Arunafelz","Another World","Islas","Dungeons Clásicos","Dungeons Nuevos");
			set .@LastWarp, 0;
			set @dmap$, "";
			...
			if( .@Zone == 1 )
			{
				if( LastWarpZ <= 1 || LastWarpM == 0 )
				{
					...
					mes "Mejor cuando te decidas elije una zona específica.";
					close;
				}
			...
			mes "[^FFA500Chronos Girl^000000]";
			mes "Cierra esta conversación para dar apertura al Warp.";
			close2;
			specialeffect 58;
			switch( rand(3) )
			{
				case 0: npctalk "Abriendo Portal a " + @dname$ + "."; break;
				case 1: npctalk "Atención viajeros, Portal a " + @dname$ + ". Buen viaje."; break;
		...
		case 6: // Breeder
			...
			switch( select("Rentar Carro (1000 zeny):Rentar Falcon (1000 zeny):Rentar Pecopeco (1000 zeny)") )
			{
				case 1: // Cart
					...
					setcart;
					mes "[^FFA500Chronos Girl^000000]";
					mes "Allí tienes tu carro. Buen día!!";
					close;
				case 2: // Falcon
					...
					setfalcon;
					mes "[^FFA500Chronos Girl^000000]";
					mes "Allí tienes tu falcon. Buen día!!";
					close;
				case 3: // Peco Peco
					...
					setriding;
					mes "[^FFA500Chronos Girl^000000]";
					mes "Allí tienes tu PecoPeco. Buen día!!";
					close;
			}
			end;
		case 7: // Reset Skills
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Vuelve cuando necesites algún servicio especial.";
				close;
			}
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Solamente realizo resets de skills cada 2 horas. Debes esperar un poco más para poder volver a resetear tus skills.";
				close;
			}
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Para resetear tus skills necesito que no excedas más de 1000 de peso de items contigo, así que deja algunas cosas en Storage y vuelve.";
				close;
			}
		...
		case 8:
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Solamente realizo resets de stats cada 2 horas. Debes esperar un poco más para poder volver a resetear tus stats.";
				close;
			}
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Para resetear tus stats necesito que no excedas más de 1000 de peso de items contigo, así que deja algunas cosas en Storage y vuelve.";
				close;
			}
		...
		case 9:
			mes "[^FFA500Chronos Girl^000000]";
			mes "El costo por el ^0000FFReset de Skills y Stats^000000 es de 450.000 zeny. Para poder realizarlo no debes superar más de 1000 de peso y no traer Pecopeco, Falcon o Carro.";
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Para resetear tus skills y stats necesito que no excedas más de 1000 de peso de items contigo, así que deja algunas cosas en Storage y vuelve.";
				close;
			}
		...
		case 10:
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Solamente realizo resets de homunculus cada 2 horas. Debes esperar un poco más para poder volver a resetear tu homunculus.";
				close;
			}
		...
		case 11:
			...
			mes "Estás listos para recibir las habilidades?";
			next;
			...
			switch( Class )
			{
				...
				case Job_Baby_Sage:
					...
					switch( sage_ele )
					{
						...
						default:
							mes "[^FFA500Chronos Girl^000000]";
							mes "Selecciona el elemento que usarás con Elemental Change.";
							next;
		...
		case 12:
			mes "[^FFA500Chronos Girl^000000]";
			mes "Este es el servicio de cambio de Profesión, para que hagas rapidamente el cambio sin tener que realizar las quests.";
			next;
			if( Upper == 1 && Class >= Job_Lord_Knight )
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Tu ya tienes el máximo de profesión permitido para tu clase y no te puedo brindar este servicio.";
				close;
			}
			...
			{
				mes "[^FFA500Chronos Girl^000000]";
				mes "Se necesita que uses todos tus skills points antes de realizar cambio de profesión.";
				mes "Vuelve pronto!!.";
				close;
			}
			...
			switch( Class )
			{
				...
				case Job_Novice:
					...
					{
						mes "[^FFA500Chronos Girl^000000]";
						mes "Por favor selecciona la profesión en la que deseas desarrollarte.";
						next;
						switch( select("Swordman:Mage:Archer:Acolyte:Merchant:Thief:Super Novice:Taekwon:Gunslinger:Ninja") )
						{
							case 7:
								...
								{
									mes "[^FFA500Chronos Girl^000000]";
									mes "No cumples los requisitos para transformate en la profesión seleccionada.";
									close;
								}
					...
					mes "[^FFA500Chronos Girl^000000]";
					mes "Estás seguro que deseas cambiar tu profesión a ^0000FF" + jobname(@target_job) + "^000000?";
					next;
				...
				default:
					...
					{ // First Class | First Advanced Class
						...
						else
						{
							...
							mes "[^FFA500Chronos Girl^000000]";
							mes "Por favor selecciona la profesión en la que quieres ser convertido.";
							next;
						...
						mes "[^FFA500Chronos Girl^000000]";
						mes "Estas preparado para cambiar de profesión a ^0000FF" + jobname(@target_job) + "^000000?";
						next;
						if( select("Si, quiero cambiar...","No gracias") == 2 )
						{
							mes "[^FFA500Chronos Girl^000000]";
					...
					{
						mes "[^FFA500Chronos Girl^000000]";
						mes "Por ahora no puedo ofrecer más servicios de este tipo.";
						close;
					}
					...
					{
						mes "[^FFA500Chronos Girl^000000]";
						mes "Tu proximo cambio de profesión se podrá tramitar cuando seas nivel 99/70.";
						close;
					}
					
					mes "[^FFA500Chronos Girl^000000]";
					mes "Estás preparado para renacer?";
					next;
					if( select("Si, quiero cambiar...","No gracias") == 2 )
					{
						mes "[^FFA500Chronos Girl^000000]";
