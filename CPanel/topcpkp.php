...
$query = sprintf(TOPCPKP);
$result = execute_query($query, "topcpkp.php");
$query2 = sprintf(TOTALCPKP);
$result2 = execute_query($query2, "topcpkp.php");
$totales = $result2->fetch_row();

opentable("Ranking de TOP de Cash/Kafra Points");
echo "
<hr><table width=\"600\">
<tr>
	...
	<td align=\"center\" class=\"head\">Cash Points</td>
	<td align=\"center\" class=\"head\">Kafra Points</td>
...
if ($result) {
	while ($line = $result->fetch_row()) {
				...
				echo '
					...
					<td align="center"><br>'.$line[8].'</td><td align="center"><br>'.$line[10].'</td>';
			if ($line[11])
...
echo "</table><BR /><BR /><center><h3>Total Cash Points de todas las cuentas: ".$totales[3]."<BR />Total Kafra Points de todas las cuentas: ".$totales[4]."</h3></center>";
closetable();
fim();
?>