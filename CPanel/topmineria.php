...
$query = sprintf(TOPMINERIA);
$result = execute_query($query, "topmineria.php");

opentable("Ranking de Mineria");
echo "
<hr><table width=\"600\">
<tr>
	...
	<td align=\"right\" class=\"head\">Puntos por Mina</td>
...
if ($result) {
	while ($line = $result->fetch_row()) {
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td align="center"><b><img src="./images/'.$line[7].'.gif"></b></td>
					<td>&nbsp;</td>
				...
				echo '
					...
					<td align="center"><img src="./images/mina.gif"><br>'.$line[8].'</td>';
			if ($line[10])
