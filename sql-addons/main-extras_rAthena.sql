...
-- rAthena implemented their own way to serialize
...
-- Missing Query required by rentstorage table

ALTER TABLE `rentstorage` ADD `unique_id` BIGINT( 20 ) NOT NULL DEFAULT '0';
