...
DROP TABLE IF EXISTS `item_serials`;
ALTER TABLE `auction` DROP COLUMN `serial`;
ALTER TABLE `cart_inventory` DROP COLUMN `serial`;
ALTER TABLE `guild_storage` DROP COLUMN `serial`;
ALTER TABLE `inventory` DROP COLUMN `serial`;
ALTER TABLE `mail` DROP COLUMN `serial`;
ALTER TABLE `storage` DROP COLUMN `serial`;
ALTER TABLE `rentstorage` DROP COLUMN `serial`;